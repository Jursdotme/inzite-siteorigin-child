 ...
 *
 * Be sure to replace all instances of 'inze_' with your project's prefix.
 ...
 */
function inze_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function inze_hide_if_no_cats( $field ) {
 ...
 */
function inze_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function inze_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object.
 */
function inze_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'inze_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function inze_register_demo_metabox() {
	$prefix = 'inze_demo_';
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'inze_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'inze_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'inze_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'inze_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'inze_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function inze_register_about_page_metabox() {
	$prefix = 'inze_about_';
...
add_action( 'cmb2_admin_init', 'inze_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function inze_register_repeatable_group_field_metabox() {
	$prefix = 'inze_group_';
...
add_action( 'cmb2_admin_init', 'inze_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function inze_register_user_profile_metabox() {
	$prefix = 'inze_user_';
...
add_action( 'cmb2_admin_init', 'inze_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function inze_register_taxonomy_metabox() {
	$prefix = 'inze_term_';
 ...
 */
function inze_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'inze_register_rest_api_box' );
/**
 ...
 */
function inze_register_rest_api_box() {
	$prefix = 'inze_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'inze_limit_rest_view_to_logged_in_users',
	) );
